...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'tesla': '0 0 20px rgba(0, 229, 255, 0.15)',
        'glow': '0 0 50px rgba(0, 229, 255, 0.25)',
        'premium': '0 25px 50px -12px rgba(0, 0, 0, 0.25)',
        'card-hover': '0 25px 50px -12px rgba(0, 0, 0, 0.15), 0 0 30px rgba(0, 229, 255, 0.1)',
      },
      scale: {
        '102': '1.02',
      },
  ...
  plugins: [
    // Custom plugin for line-clamp utility
